...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            <h1 class="h3">Editar Gasto #{{ $expense->id }}</h1>
        </div>
        <div class="col-auto">
            ...
            <form action="{{ route('expenses.update', $expense) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select class="form-select @error('currency') is-invalid @enderror" id="currency" name="currency" required>
                            <option value="COP" {{ old('currency', $expense->currency) == 'COP' ? 'selected' : '' }}>COP</option>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('accommodation_id') is-invalid @enderror" id="accommodation_id" name="accommodation_id">
                            ...
                            @foreach($accommodations as $accommodation)
                                <option value="{{ $accommodation->id }}" {{ old('accommodation_id', $expense->accommodation_id) == $accommodation->id ? 'selected' : '' }}>
                                    {{ $accommodation->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control @error('expense_date') is-invalid @enderror" id="expense_date" name="expense_date" value="{{ old('expense_date', $expense->expense_date ? $expense->expense_date->format('Y-m-d') : '') }}" required>
                        @error('expense_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('payment_method') is-invalid @enderror" id="payment_method" name="payment_method" value="{{ old('payment_method', $expense->payment_method) }}">
