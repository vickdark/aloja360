...
class UpdateAccommodationRequest extends FormRequest
{
    ...
    {
        $accommodationId = $this->route('accommodation')?->id ?? $this->route('accommodation');

        return [
            'code' => 'required|string|max:50|unique:accommodations,code,' . $accommodationId,
            'name' => 'required|string|max:255',
            'slug' => 'nullable|string|max:255|unique:accommodations,slug,' . $accommodationId,
            ...
            'day_pass_price_per_child' => 'nullable|numeric|min:0',
